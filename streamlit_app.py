...
genai.configure(api_key="AIzaSyBBXFJro5qcUY7MTxd3hEHj8zXop6C7CZM")
...
st.sidebar.write("Made by Anurag")
st.sidebar.write("Powered by google gemini ai")
st.header("Robobill")
st.subheader("Made by Anurag")
...
input_prompt = """
You are an expert in reading invoiced, we are going to upload an image of an invoice
...
At the end, make sure to repeat the name out of app "Robobill" and 
